...
if ~strcmp(pFlag,'inner')
   ...
   % [minout,minSens] = obj.sedumiminouterbound(QOIobj,frac,abE,rflag,QOIobj);
   % [maxout,maxSens] = obj.sedumimaxouterbound(QOIobj,frac,abE,rflag,QOIobj);
   warning('off','all');
   [minout,minSens,xs_min] = obj.cvxminouterbound(QOIobj,frac,abE,rflag,QOIobj);
   [maxout,maxSens,xs_max] = obj.cvxmaxouterbound(QOIobj,frac,abE,rflag,QOIobj);
   warning('on','all');
