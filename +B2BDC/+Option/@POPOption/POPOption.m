classdef POPOption < handle
   ...
   methods
      function  obj = POPOption(inputCell)
         ...
         p = {'relaxOrder','sparseSW','perturbation',...
      ...
      function set.relaxOrder(obj,num1)
         if num1 == -1
            obj.relaxOrder = -1;
         elseif num1 > 0
            obj.relaxOrder = ceil(num1);
         else
